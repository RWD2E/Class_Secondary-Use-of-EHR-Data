...
```{r}
cor(aset$AGE_AT_DX_DATE1,aset$RILUZ_DUR,method="pearson")
```

*Spearman Correlation*
```{r}
cor(aset$AGE_AT_DX_DATE1,aset$RILUZ_DUR,method="spearman")
```
...
```{r}
ggplot(aset, aes(x=AGE_AT_DX_DATE1,y=RILUZ_DUR))+
  geom_point()+
