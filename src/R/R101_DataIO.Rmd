...
dat1b<-tbl(
    myconn,
    in_schema("SHARED_DB.ALS","ALS_RILUZOLE_DEATH_FINAL")
) %>% 
  collect() 
```
...
```{r}
write.csv(dat1a,file="C:/Users/Administrator/Documents/classHMI7001/data/als_aset.csv")
```

Then, how do we read the .csv file back into R?

```{r}
dat1_csv<-read.csv("C:/Users/Administrator/Documents/classHMI7001/data/als_aset.csv")
```

## save dataframe as delimiter separated file (.txt)
```{r}
write.table(dat1a,file="C:/Users/Administrator/Documents/classHMI7001/data/als_aset.txt",sep="|")
```

Then, how do we read the .csv file back into R?

```{r}
dat1_txt<-read.table("C:/Users/Administrator/Documents/classHMI7001/data/als_aset.txt",sep="|")
```
